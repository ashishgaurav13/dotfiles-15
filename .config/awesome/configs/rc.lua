...
-- mytextclock = awful.widget.textclock(markup("#7788af", "%a %d %b "))
mytextclock = awful.widget.textclock(markup("#f9f9f9", "%a %d %b "))
...
netupinfo = lain.widgets.net({
    settings = function()
        ...
        widget:set_markup(markup("#e54c62", string.format("%5s %s ", net_now.sent, net_now.units)))
        netdowninfo:set_markup(markup("#87af5f", string.format("%5s %s ", net_now.received, net_now.units)))
    end
})
